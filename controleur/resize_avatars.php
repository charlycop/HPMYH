...
$product85=image_resize($uploadfile, ''.$uploaddir.''.$last_order['id_order'].'_85x85'.$pic_type.'', 85, 85, 1);
$product500=image_resize($uploadfile, ''.$uploaddir.''.$last_order['id_order'].'_500x500'.$pic_type.'', 500, 500, 0);

//On modifie la variable définitivement pour les prochaines sessions
	include_once ('../modele/post_avatar.php');
	$post_avatar = post_avatar($last_order['id_order'], $pic_type);